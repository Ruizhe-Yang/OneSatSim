...
record ObcComponentConfig "obc硬件设计配置"
  parameter Modelica.Units.SI.Resistance ProcessorLoadResistance
    "OBC处理器等效负载电阻；Excel工程单位Ω";
  parameter Modelica.Units.SI.HeatCapacity CPUHeatCapacity
    "CPU等效热容；Excel工程单位J/K";
  parameter Modelica.Units.SI.HeatCapacity BoardHeatCapacity
    "OBC板等效热容；Excel工程单位J/K";
  parameter Modelica.Units.SI.ThermalConductance CPUBoardConductance
    "CPU-板导热；Excel工程单位W/K";
  parameter Modelica.Units.SI.ThermalConductance BoardMountConductance
    "OBC安装导热；Excel工程单位W/K";
