...
record SelfieCameraComponentConfig "selfieCamera硬件设计配置"
  ...
  parameter Modelica.Units.SI.Resistance CMOSLoadResistance
    "CMOS相机负载电阻；Excel工程单位Ω";
  parameter Modelica.Units.SI.HeatCapacity ImagerHeatCapacity
    "自拍相机热容；Excel工程单位J/K";
  parameter Modelica.Units.SI.ThermalConductance MountConductance
    "自拍相机安装导热；Excel工程单位W/K";
...
end SelfieCameraComponentConfig;
