...
record TtcReceiverComponentConfig "ttcReceiver硬件设计配置"
  parameter Modelica.Units.SI.Resistance ReceiverLoadResistance
    "测控接收机负载电阻；Excel工程单位Ω";
  parameter Modelica.Units.SI.Resistance RFChokeResistance
    "射频串联等效损耗；Excel工程单位Ω";
  parameter Modelica.Units.SI.HeatCapacity HeatCapacity
    "接收机等效热容；Excel工程单位J/K";
  parameter Modelica.Units.SI.ThermalConductance MountConductance
    "接收机安装导热；Excel工程单位W/K";
...
end TtcReceiverComponentConfig;
